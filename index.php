...
$topLearners = inkwell_top_learners(10);
$totalLessons = 0;
...
$__notifItems = $__me ? inkwell_list_notifications($__me['id']) : [];
$__notifUnread = $__me ? inkwell_count_unread_notifications($__me['id']) : 0;
$__msgUnread = $__me ? inkwell_count_unread_messages($__me['id']) : 0;
  ...
  <div class="drive-shell">
    ...
    <aside class="drive-sidebar" id="driveSidebar">
        ...
        <?php if ($__me): ?>
          <div class="drive-user-wrap">
            ...
            <div class="drive-user-menu" id="driveUserMenu">
              ...
              <a href="/settings.php"><span class="drive-nav-icon">⚙️</span>Settings</a>
              <?php if ($__me['role'] === 'student'): ?>
                <a href="/grades.php"><span class="drive-nav-icon">📊</span>My Grades</a>
              <?php endif; ?>
      ...
      <nav class="drive-nav">
        ...
        <?php if ($__me && inkwell_user_has_marketplace_selling_access($__me)): ?>
          <a class="drive-nav-link" href="/sell.php"><span class="drive-nav-icon">💰</span>My marketplace dashboard</a>
        <?php endif; ?>
        ...
        <?php if (!$__me || $__me['role'] === 'student'): ?>
          ...
          <a class="drive-nav-link" href="<?php echo $__me ? '/grades.php' : '/login.php?next=' . urlencode('/grades.php'); ?>"><span class="drive-nav-icon">📊</span>My Grades</a>
        <?php endif; ?>
        ...
        <?php if ($__me): ?>
          ...
          <a class="drive-nav-link" href="/messages.php">
            <span class="drive-nav-icon">💬</span>Messages
            <?php if ($__msgUnread > 0): ?><span class="notif-bell-badge" style="position:static; margin-left:auto;"><?php echo $__msgUnread > 9 ? '9+' : (int) $__msgUnread; ?></span><?php endif; ?>
          </a>
          <a class="drive-nav-link" href="/notes.php"><span class="drive-nav-icon">📝</span>Notes</a>
        <?php endif; ?>
        <a class="drive-nav-link" href="/marketplace.php"><span class="drive-nav-icon">🛒</span>Marketplace</a>
        ...
        <?php if ($__me): ?>
          <a class="drive-nav-link" href="/settings.php"><span class="drive-nav-icon">⚙️</span>Settings</a>
        <?php endif; ?>
      </nav>
      ...
      <div class="drive-topbar-row">
        ...
        <div class="drive-topbar-right">
          <?php if (!empty($topLearners)): ?>
            ...
            <div class="top-learners-wrap" id="topLearnersWrap">
              <div class="drive-avatars">
                <?php foreach (array_slice($topLearners, 0, 3) as $tl): ?>
                ...
                <?php endforeach; ?>
                <?php if (count($topLearners) > 3): ?>
                  <button type="button" class="drive-avatar-add drive-avatar-more" id="topLearnersMoreBtn" aria-haspopup="true" aria-expanded="false" title="See all top learners">+<?php echo count($topLearners) - 3; ?></button>
                <?php else: ?>
                  <a class="drive-avatar-add" href="/register.php" title="Join Inkwell">+</a>
                <?php endif; ?>
              </div>
              <?php if (count($topLearners) > 3): ?>
                <div class="top-learners-panel" id="topLearnersPanel">
                  <div class="top-learners-panel-head"><strong>Top learners</strong></div>
                  <div class="top-learners-list">
                    <?php foreach ($topLearners as $__i => $tl): ?>
                      <div class="top-learners-item">
                        <span class="top-learners-rank">#<?php echo $__i + 1; ?></span>
                        <span class="drive-avatar-chip" title="<?php echo htmlspecialchars($tl['name']); ?>">
                          <?php if (!empty($tl['avatar'])): ?>
                            <img src="/assets/uploads/<?php echo htmlspecialchars($tl['avatar']); ?>" alt="" loading="lazy">
                          <?php else: ?>
                        ...
                        <span class="top-learners-name"><?php echo htmlspecialchars($tl['name']); ?></span>
                      </div>
                    <?php endforeach; ?>
                  </div>
                </div>
          ...
          <div class="drive-toolbar">
            <?php if ($__me): ?><?php include __DIR__ . '/includes/user_search_widget.php'; ?><?php endif; ?>
            <?php if ($__me): ?><?php include __DIR__ . '/includes/notifications_bell.php'; ?><?php endif; ?>
