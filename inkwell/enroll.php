...
?>
      ...
      <?php foreach ($approvedSubjects as $s): ?>
        <div class="enroll-status-row">
          ...
          <div style="display:flex; align-items:center; gap:10px;">
            ...
            <form method="post" action="/enroll.php" onsubmit="return confirm('Leave this class?');">
      ...
      <?php foreach ($pendingSubjects as $s): ?>
        <div class="enroll-status-row">
          ...
          <div style="display:flex; align-items:center; gap:10px;">
            ...
            <form method="post" action="/enroll.php" onsubmit="return confirm('Cancel this request?');">
  ...
  <script>
    (function () {
      ...
      // only matches that exact value.
      function filterByTermAndYear(list, term, year) {
      ...
      function refreshFiltered() {
        ...
        filteredCurriculum = filterByTermAndYear(curriculum, term, year);
        filteredPickable = filterByTermAndYear(pickable, term, year);
