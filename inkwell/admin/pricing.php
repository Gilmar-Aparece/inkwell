  ...
  <main class="admin-main">
    ...
    <section class="admin-card glass-card">
      ...
      <form method="post" action="/admin/pricing.php" class="admin-form">
        ...
        <label class="admin-checkbox-label">
          <input type="checkbox" name="unlocks_marketplace_selling" value="1">
          Unlocks selling on the marketplace (any account, not just students/teachers)
        </label>
        ...
        <?php foreach ($plans as $plan): ?>
          <details class="plan-admin-row<?php echo $plan['is_active'] ? '' : ' inactive'; ?>">
            <summary>
              ...
              <?php if (!empty($plan['unlocks_marketplace_selling'])): ?><span class="badge-status-active">Unlocks marketplace selling</span><?php endif; ?>
            ...
            <form method="post" action="/admin/pricing.php" class="admin-form">
              ...
              <label class="admin-checkbox-label">
                <input type="checkbox" name="unlocks_marketplace_selling" value="1" <?php echo !empty($plan['unlocks_marketplace_selling']) ? 'checked' : ''; ?>>
                Unlocks selling on the marketplace (any account, not just students/teachers)
              </label>
              <label>Badge</label>
