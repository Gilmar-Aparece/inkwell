...
if ($user['role'] === 'teacher') {
  ...
  <main class="admin-main">
    ...
    <p class="admin-sub" style="margin-top:-8px;">Every subject you teach, grouped by year level.</p>
...
<main class="admin-main">
  ...
  <p class="admin-sub" style="margin-top:-8px;">Every subject/class under your section — the same block your classmates are taking. Join the ones you haven't yet.</p>
