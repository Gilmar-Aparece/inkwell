...
<main>
  <div class="billing-page">
    <div class="billing-header">
      ...
      <p class="admin-sub">Browse systems built by Inkwell students and teachers — preview them live, then buy directly from the builder via GCash.</p>
    </div>
    ...
    <div class="mkt-toolbar">
      ...
      <?php if ($me && inkwell_marketplace_can_sell($me)): ?>
        <a href="/sell.php" class="btn primary">+ Sell a system</a>
      <?php elseif ($me): ?>
        <a href="/marketplace-library.php" class="btn">My marketplace dashboard</a>
      <?php else: ?>
    ...
    <?php if (!$listings): ?>
      <section class="admin-card glass-card">
        <p class="admin-sub">No systems here yet<?php echo $activeCat || $search ? ' matching that filter' : ''; ?>. <?php if ($me && inkwell_marketplace_can_sell($me)): ?>Be the first — <a href="/sell.php">list yours</a>.<?php endif; ?></p>
      </section>
    <?php else: ?>
      <div class="mkt-grid">
          ...
          <div class="mkt-card glass-card">
            <a href="/marketplace-view.php?slug=<?php echo urlencode($l['slug']); ?>" class="mkt-card-thumb-link">
              <div class="mkt-card-thumb">
                ...
                <?php else: ?>
                  <span class="mkt-card-thumb-fallback"><?php echo htmlspecialchars($l['category_icon'] ?: '💻'); ?></span>
                <?php endif; ?>
