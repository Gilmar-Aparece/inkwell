...
<main class="landing-main">
  ...
  <section class="landing-section landing-section-alt" id="how-it-works">
    ...
    <p class="landing-section-sub">Three ways to use Inkwell — pick the one that's you.</p>

    <div class="dept-tabs dept-tabs-landing" id="howTabs" role="tablist" aria-label="Choose your path">
      <button type="button" class="dept-tab active" role="tab" data-how-target="how-students">🎓 Students</button>
      <button type="button" class="dept-tab" role="tab" data-how-target="how-schools">🏫 Schools</button>
      <button type="button" class="dept-tab" role="tab" data-how-target="how-sellers">🛒 Sellers</button>
    </div>

    <div class="how-panels">
      <div class="how-panel active" id="how-students" role="tabpanel">
        <ol class="how-steps">
          <li class="how-step">
            <span class="how-step-num">1</span>
            <div class="how-step-body"><strong>Create your free account</strong><p>No card required. Pick a track and jump straight into your first lesson.</p></div>
          </li>
          <li class="how-step">
            <span class="how-step-num">2</span>
            <div class="how-step-body"><strong>Learn by writing real code</strong><p>Bite-sized lessons and a live in-browser playground across HTML, CSS, JS, PHP, Python, Java, C/C++, and C#.</p></div>
          </li>
          <li class="how-step">
            <span class="how-step-num">3</span>
            <div class="how-step-body"><strong>Join your school</strong><p>Search for your school and send an enrollment request — once your teacher approves it, you're linked to your classes.</p></div>
          </li>
          <li class="how-step">
            <span class="how-step-num">4</span>
            <div class="how-step-body"><strong>Get certified</strong><p>Pass certification exams and download a certificate carrying your school's name, logo, and signature.</p></div>
          </li>
        </ol>
      </div>

      <div class="how-panel" id="how-schools" role="tabpanel">
        <ol class="how-steps">
          <li class="how-step">
            <span class="how-step-num">1</span>
            <div class="how-step-body"><strong>Create your school</strong><p>Pick a plan and set up your school's profile in a few minutes.</p></div>
          </li>
          <li class="how-step">
            <span class="how-step-num">2</span>
            <div class="how-step-body"><strong>Build your staff</strong><p>Add registrars, deans, and teachers, each with the right level of access.</p></div>
          </li>
          <li class="how-step">
            <span class="how-step-num">3</span>
            <div class="how-step-body"><strong>Students enroll</strong><p>Students find your school and request to join — approve them and they're in.</p></div>
          </li>
          <li class="how-step">
            <span class="how-step-num">4</span>
            <div class="how-step-body"><strong>Brand every certificate</strong><p>Every certificate your teachers issue carries your school's logo and signature, tracked from one dashboard.</p></div>
          </li>
        </ol>
      </div>

      <div class="how-panel" id="how-sellers" role="tabpanel">
        <ol class="how-steps">
          <li class="how-step">
            <span class="how-step-num">1</span>
            <div class="how-step-body"><strong>Create a seller account</strong><p>Get started for ₱149/month — no student or teacher account required.</p></div>
          </li>
          <li class="how-step">
            <span class="how-step-num">2</span>
            <div class="how-step-body"><strong>List your system</strong><p>Upload what you built to the marketplace and set your own unlock price.</p></div>
          </li>
          <li class="how-step">
            <span class="how-step-num">3</span>
            <div class="how-step-body"><strong>Get paid</strong><p>Buyers unlock your listing and pay straight into your own GCash.</p></div>
          </li>
          <li class="how-step">
            <span class="how-step-num">4</span>
            <div class="how-step-body"><strong>Track it all</strong><p>Your seller dashboard shows every sale and payout in one place.</p></div>
          </li>
        </ol>
      </div>
    </div>
    ...
    (function () {
      ...
      buttons.forEach(function (b) {
        b.addEventListener('click', function () {
          var target = b.getAttribute('data-how-target');
      ...
      ?>
        <div class="plan-card glass-card<?php echo !empty($plan['badge']) ? ' featured' : ''; ?>">
          ...
          <?php else: ?>
            ...
            <?php if ($plan['audience'] === 'both' && !$isFree && !inkwell_plan_unlocks_marketplace_selling($plan)): ?>
