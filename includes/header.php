...
<header class="topbar">
  ...
  <div class="topbar-right">
    <nav class="topnav" id="topnav">
      ...
      <?php if (!$__navUser): ?>
        <a href="/index.php#how-it-works" class="playground-link playground-link-outline">How it works</a>
        <a href="/index.php#pricing" class="playground-link playground-link-outline">Pricing</a>
      <?php endif; ?>
