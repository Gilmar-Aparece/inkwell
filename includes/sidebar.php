...
<aside class="sidebar" id="sidebar">
  ...
  <?php if ($__sidebarMe): ?>
    <div class="drive-user-wrap sidebar-account">
      ...
      <div class="drive-user-menu" id="driveUserMenu">
        ...
        <?php if ($__sidebarMe['role'] === 'student'): ?>
        ...
        <a href="/sell.php"><span class="drive-nav-icon">💰</span>My marketplace dashboard</a>
        <a href="/my-billing.php"><span class="drive-nav-icon">💳</span>My billing</a>
  ...
  <a class="sidebar-link sidebar-marketplace-link" href="/marketplace.php"><span class="drive-nav-icon">🛒</span>Marketplace</a>
  <?php if ($__sidebarMe && $__sidebarMe['role'] === 'student'): ?>
    <a class="sidebar-link" href="/grades.php"><span class="drive-nav-icon">📊</span>My Grades</a>
  <?php endif; ?>
