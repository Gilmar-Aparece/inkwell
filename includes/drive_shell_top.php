...
require_once __DIR__ . '/marketplace.php'; // for inkwell_user_has_marketplace_selling_access() below
require_once __DIR__ . '/notifications.php';
require_once __DIR__ . '/messages.php';
$__driveCanSell = $__me ? inkwell_user_has_marketplace_selling_access($__me) : false;
...
?>
<?php if ($__me): ?><?php include __DIR__ . '/post_author_profile_modal.php'; ?><?php endif; ?>
<main>
  <div class="drive-shell">
    ...
    <aside class="drive-sidebar" id="driveSidebar">
      ...
      <nav class="drive-nav">
        ...
        <a class="drive-nav-link<?php echo $driveActive === 'billing' ? ' active' : ''; ?>" href="<?php echo $__me ? '/my-billing.php' : '/login.php?next=' . urlencode('/my-billing.php'); ?>"><span class="drive-nav-icon">💳</span>My billing</a>
        <?php if ($__driveCanSell): ?>
          <a class="drive-nav-link<?php echo $driveActive === 'sell' ? ' active' : ''; ?>" href="/sell.php"><span class="drive-nav-icon">💰</span>My marketplace dashboard</a>
        <?php endif; ?>
        ...
        <?php if (!$__me || $__me['role'] === 'student'): ?>
          ...
          <a class="drive-nav-link<?php echo $driveActive === 'grades' ? ' active' : ''; ?>" href="<?php echo $__me ? '/grades.php' : '/login.php?next=' . urlencode('/grades.php'); ?>"><span class="drive-nav-icon">📊</span>My Grades</a>
        <?php endif; ?>
        ...
        <?php if ($__me): ?>
          ...
          <a class="drive-nav-link<?php echo $driveActive === 'messages' ? ' active' : ''; ?>" href="/messages.php">
        ...
        <?php endif; ?>
        <a class="drive-nav-link<?php echo $driveActive === 'marketplace' ? ' active' : ''; ?>" href="/marketplace.php"><span class="drive-nav-icon">🛒</span>Marketplace</a>
        ...
        <?php if ($__me): ?>
          <a class="drive-nav-link<?php echo $driveActive === 'settings' ? ' active' : ''; ?>" href="/settings.php"><span class="drive-nav-icon">⚙️</span>Settings</a>
        <?php endif; ?>
      </nav>
      ...
      <div class="drive-topbar-row">
        ...
        <div class="drive-topbar-right">
          <div class="drive-toolbar">
            <?php if ($__me): ?><?php include __DIR__ . '/user_search_widget.php'; ?><?php endif; ?>
            <?php if ($__me): ?><?php include __DIR__ . '/notifications_bell.php'; ?><?php endif; ?>
