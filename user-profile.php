...
<div class="student-profile-actions" style="display:flex; gap:8px; margin:0 0 16px;">
  <a class="btn" href="/profile.php?id=<?php echo (int) $a['id']; ?>" style="flex:1; text-align:center;">View full profile →</a>
  <?php if ((int) $a['id'] !== (int) $viewer['id']): ?>
    <a class="btn primary" href="/messages.php?with=<?php echo (int) $a['id']; ?>" style="flex:1; text-align:center;">💬 Message</a>
  <?php endif; ?>
</div>
